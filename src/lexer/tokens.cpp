...
static const std::vector<std::pair<std::string, TokenType>> RegexsTokens = {
    ...
    // Literales
    {"\"([ -\t]|[\v-~])*\"",
     TokenType::STRING},  // falta evitar que se ponga \n y \" en .*
    {"'.'", TokenType::CHAR},
...
std::string TokenType_to_string(TokenType type) {
  switch (type) {
    ...
    case TokenType::KW_SELF:
      return "KW_SELF";
    case TokenType::KW_BASE:
      return "KW_BASE";
    case TokenType::KW_PROTOCOL:
      return "KW_PROTOCOL";
    case TokenType::KW_EXTECNDS:
      return "KW_EXTECNDS";
    case TokenType::TRUE:
      return "TRUE";
    case TokenType::FALSE:
      return "FALSE";
    case TokenType::T_OBJECT:
      return "T_OBJECT";
    ...
    case TokenType::OP_DECREMENT:
      return "OP_DECREMENT";
    case TokenType::OP_DOBLE_CONCAT:
      return "OP_DOBLE_CONCAT";
    case TokenType::OP_DESTRUCT_ASSIGN:
      return "OP_DESTRUCT_ASSIGN";
